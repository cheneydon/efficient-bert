...
FORMAT_WIKI_PATH='./dataset/pretrain_data/format_data/wikipedia_en_format.txt'
WIKI_SAVE_DIR='./dataset/pretrain_data/wikipedia_nomask'

DOWNLOAD_BOOK_DIR='./dataset/pretrain_data/download_bookcorpus'
FORMAT_BOOK_PATH='./dataset/pretrain_data/format_data/bookcorpus_format.txt'
BOOK_SAVE_DIR='./dataset/pretrain_data/bookcorpus_nomask'


# Wikipedia
python pretrain_data_scripts/wiki_extractor.py --input $WIKI_XML_PATH -b '100M' --processes 4 -o $EXTRACTED_WIKI_DIR
python pretrain_data_scripts/text_formatting.py --wiki_dir $EXTRACTED_WIKI_DIR --output_dir $FORMAT_DATA_DIR
...
# Bookscorpus
python pretrain_data_scripts/text_formatting.py --book_dir $DOWNLOAD_BOOK_DIR --output_dir $FORMAT_DATA_DIR
python pretrain_data_scripts/create_data.py \
